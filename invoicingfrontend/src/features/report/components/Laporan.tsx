...
const REPORT_TYPES = [
  ...
  {
    id: "sj_2",
    title: "Surat Jalan (A4 / Kwarto / 1/2 Kwarto) - Font 10",
    type: "item",
  },
  ...
  {
    id: "inv_7",
    title: "Invoice Sederhana - Tanpa Disc & DP (A4 / Letter / Kuarto)",
    type: "item",
  },
  { id: "inv_8", title: "Invoice Plus Kwitansi", type: "item" },
  {
    id: "inv_9",
    title: "Invoice Plus Surat Jalan (1 SJ / 1 Invoice)",
    type: "item",
  },
  {
    id: "inv_10",
    title: "Invoice Plus Surat Jalan (1 SJ / 1 Invoice) - Font 10",
    type: "item",
  },
  ...
  {
    id: "bpk_1",
    title: "Bukti Penerimaan Kas/Bank (1/2 Kwarto)",
    type: "item",
  },
  ...
  {
    id: "spt_8",
    title: "Lampiran Daftar Faktur Pajak Diganggung - 1111 A (Legal/Folio)",
    type: "item",
  },
];
...
const Laporan: React.FC = () => {
  ...
  const [filter, setFilter] = useState({
    ...
    dari_no_kwitansi: "",
    sampai_no_kwitansi: "",
    dari_no_faktur_pajak: "",
    sampai_no_faktur_pajak: "",
    dari_no_nk: "",
    sampai_no_nk: "",
    dari_no_po: "",
    sampai_no_po: "",
    dari_no_pembayaran: "",
    sampai_no_pembayaran: "",
    no_retur_penjualan: "",
    no_retur_pembelian: "",
    dari_tanggal: "",
    sampai_tanggal: "",
  ...
  useEffect(() => {
    ...
    if (
      ...
      setFilter((prev) => ({
        ...
        sampai_no_pembayaran:
          pembayaranNumberParam || prev.sampai_no_pembayaran,
  ...
  const handleCetakPDF = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      toast.error(
        "Gagal men-generate laporan. Pastikan koneksi server berjalan.",
        { id: toastId },
      );
    } finally {
      setIsLoading(false);
  ...
  const inputClass =
    "w-full h-9 px-3 border border-gray-300 rounded-sm text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed";
      ...
      <div className="p-6 bg-slate-900 w-full rounded-none flex items-center justify-between shrink-0">
        <div>
          ...
          <p className="text-sm text-slate-300 mt-1">
            Pusat pencetakan dokumen PDF multi-modul
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-row w-full h-[calc(100vh-100px)] overflow-hidden">
            ...
            {REPORT_TYPES.map((report) => {
              if (report.type === "header") {
                return (
                  <li
                    key={report.id}
                    className="font-bold text-gray-800 bg-gray-100 py-2 px-4 mt-2"
                  >
                    {report.title}
                  </li>
                );
        ...
        <div className="w-2/3 md:w-[70%] overflow-y-auto bg-white p-8">
          <div className="max-w-4xl">
            ...
            <div className={rowClass}>
              ...
              <div className={inputWrapperClass}>
                <input
                  type="number"
                  className={`${inputClass} max-w-[120px]`}
                  value={filter.pembetulan}
                  onChange={(e) =>
                    handleFilterChange("pembetulan", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className={rowClass}>
              <label
                className={`${labelClass} ${!isSoActive && "text-gray-400"}`}
              >
                Dari No. Sales Order
              </label>
              <div className={inputWrapperClass}>
                <input
                  ...
                  disabled={!isSoActive}
                  value={filter.dari_no_so}
                  onChange={(e) =>
                    handleFilterChange("dari_no_so", e.target.value)
                  }
                />
                <span className="text-sm font-semibold text-gray-500 whitespace-nowrap px-2">
                  s/d
                </span>
                <input
                  type="text"
                  className={inputClass}
                  disabled={!isSoActive}
                  value={filter.sampai_no_so}
                  onChange={(e) =>
                    handleFilterChange("sampai_no_so", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className={rowClass}>
              <label
                className={`${labelClass} ${!isSjActive && "text-gray-400"}`}
              >
                Dari No. Surat Jalan
              </label>
              <div className={inputWrapperClass}>
                <input
                  ...
                  className={inputClass}
                  disabled={!isSjActive}
                  value={filter.dari_no_sj}
                  onChange={(e) =>
                    handleFilterChange("dari_no_sj", e.target.value)
                  }
                />
                <span className="text-sm font-semibold text-gray-500 whitespace-nowrap px-2">
                  s/d
                ...
                <input
                  ...
                  className={inputClass}
                  disabled={!isSjActive}
                  value={filter.sampai_no_sj}
                  onChange={(e) =>
                    handleFilterChange("sampai_no_sj", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className={rowClass}>
              <label
                className={`${labelClass} ${!isInvActive && "text-gray-400"}`}
              >
                Dari No. Invoice
              </label>
              <div className={inputWrapperClass}>
                <input
                  type="text"
                  className={inputClass}
                  disabled={!isInvActive}
                  value={filter.dari_no_invoice}
                  onChange={(e) =>
                    handleFilterChange("dari_no_invoice", e.target.value)
                  }
                />
                <span className="text-sm font-semibold text-gray-500 whitespace-nowrap px-2">
                  s/d
                ...
                <input
                  ...
                  className={inputClass}
                  disabled={!isInvActive}
                  value={filter.sampai_no_invoice}
                  onChange={(e) =>
                    handleFilterChange("sampai_no_invoice", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className={rowClass}>
              <label
                className={`${labelClass} ${!isPembayaranActive && "text-gray-400"}`}
              >
                Dari No. Pembayaran
              </label>
              <div className={inputWrapperClass}>
                <input
                  type="text"
                  className={inputClass}
                  disabled={!isPembayaranActive}
                  value={filter.dari_no_pembayaran}
                  onChange={(e) =>
                    handleFilterChange("dari_no_pembayaran", e.target.value)
                  }
                />
                <span className="text-sm font-semibold text-gray-500 whitespace-nowrap px-2">
                  s/d
                ...
                <input
                  ...
                  className={inputClass}
                  disabled={!isPembayaranActive}
                  value={filter.sampai_no_pembayaran}
                  onChange={(e) =>
                    handleFilterChange("sampai_no_pembayaran", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className={rowClass}>
              <label
                className={`${labelClass} ${!isKwitansiActive && "text-gray-400"}`}
              >
                Dari No. Kwitansi
              </label>
              <div className={inputWrapperClass}>
                <input
                  type="text"
                  className={inputClass}
                  disabled={!isKwitansiActive}
                  value={filter.dari_no_kwitansi}
                  onChange={(e) =>
                    handleFilterChange("dari_no_kwitansi", e.target.value)
                  }
                />
                <span className="text-sm font-semibold text-gray-500 whitespace-nowrap px-2">
                  s/d
                ...
                <input
                  ...
                  className={inputClass}
                  disabled={!isKwitansiActive}
                  value={filter.sampai_no_kwitansi}
                  onChange={(e) =>
                    handleFilterChange("sampai_no_kwitansi", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className={rowClass}>
              <label className={`${labelClass} text-gray-400`}>
                Dari No Faktur Pajak
              </label>
              <div className={inputWrapperClass}>
              ...
              <button
                ...
                onClick={() => {
                  const queryParams = new URLSearchParams({
                    ...
                    ...(filter.dari_no_invoice
                      ? { no_invoice: filter.dari_no_invoice }
                      : {}),
                    ...(filter.dari_no_pembayaran
                      ? { no_pembayaran: filter.dari_no_pembayaran }
                      : {}),
                  });
                  window.open(
                    `/preview-laporan?${queryParams.toString()}`,
                    "_blank",
                  );
                }}
