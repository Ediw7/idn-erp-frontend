...
interface SalesOrderSjModalProps {
  sjForm: { pelanggan_id: string; alamat_kirim: string; no_so: string; gudang_id: string; tanggal: string };
...
export const SalesOrderSjModal: React.FC<SalesOrderSjModalProps> = ({
  sjForm, setSjForm, pelanggans, gudangs, dataList, onClose, onSubmit
}) => {
  return (
