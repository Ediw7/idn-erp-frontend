      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-4">
        ...
        <div className="bg-white border-l-4 border-l-blue-600 border-y border-r border-slate-300 rounded-sm shadow-sm p-4 shrink-0 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            {form.is_closed && (
              <span className="px-3 py-1 bg-slate-200 text-slate-700 font-bold text-xs rounded-sm border border-slate-300">
                CLOSED
              </span>
            )}
          </div>
        ...
        <div className="bg-white border border-slate-300 rounded-sm shadow-sm flex flex-col shrink-0 flex-1">
          <div className="px-3 pt-2 bg-slate-100 border-b border-slate-300 flex gap-1">
            {(["umum", "detail", "surat_jalan", "outstanding"] as const).map(
              (tab) => {
                const labels = {
                  umum: "Informasi Umum",
              ...
              <div className="flex flex-col gap-2 mb-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    disabled={isReadOnly}
                    type="number"
                    className="w-48 px-3 py-1.5 text-right bg-white border border-slate-300 focus:outline-none focus:border-blue-500 font-mono text-sm rounded-sm disabled:bg-slate-100 disabled:text-slate-500"
                    value={form.potongan_harga || ""}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        potongan_harga: Number(e.target.value),
                      })
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      disabled={isReadOnly}
                      type="number"
                      className="w-16 px-2 py-1.5 text-center bg-white border border-slate-300 focus:outline-none focus:border-blue-500 text-sm rounded-sm disabled:bg-slate-100 disabled:text-slate-500"
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        type="number"
                        className="w-16 px-2 py-1.5 text-center bg-white border border-slate-300 focus:outline-none focus:border-blue-500 text-sm rounded-sm disabled:bg-slate-100 disabled:text-slate-500"
                        value={form.ppnbm_persen || ""}
                        onChange={(e) =>
                          setForm({
                            ...form,
                            ppnbm_persen: Number(e.target.value),
                          })
                        }
                      />
                    </div>
                    <input
                      type="text"
                      readOnly
                      className="w-48 px-3 py-1.5 text-right bg-slate-100 border border-slate-300 font-mono text-sm rounded-sm text-purple-700"
                      value={ppnbmAmount.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                      })}
                    />
                  </div>
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <input
                    ...
                    type="number"
                    className="w-48 px-3 py-1.5 text-right bg-white border border-slate-300 focus:outline-none focus:border-blue-500 font-mono text-sm rounded-sm disabled:bg-slate-100 disabled:text-slate-500"
                    value={form.ongkos_angkut || ""}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        ongkos_angkut: Number(e.target.value),
                      })
                    }
                  />
                </div>
