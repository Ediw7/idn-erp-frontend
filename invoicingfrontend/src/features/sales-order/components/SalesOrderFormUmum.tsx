        ...
        <div className="flex-1 flex flex-col gap-3">
          <div className="flex items-start">
            ...
            >
              ...
              {dataList.map((so) => (
                <option key={so.id || so.no_so} value={so.no_so}>
                  {so.no_so}
                </option>
              ))}
            </select>
          ...
          <div className="flex items-start">
            ...
            <input
              ...
              value={form.tgl_so || ""}
              onChange={(e) => setForm({ ...form, tgl_so: e.target.value })}
            />
          </div>
          <div className="flex items-start">
            ...
            <div className="flex gap-2 w-full">
              <select
                ...
                onChange={(e) => handlePelangganChange(Number(e.target.value))}
              >
                <option value="">
        ...
        <div className="flex-1 flex flex-col gap-3">
          <div className="flex items-start">
            ...
            <input
              ...
              placeholder="Isi manual dari PO pelanggan"
              value={form.no_po || ""}
          ...
          <div className="flex items-start">
            ...
            <input
              ...
              type="text"
              className={`${inputClass} w-full`}
              value={form.dipesan_oleh || ""}
              onChange={(e) =>
                setForm({ ...form, dipesan_oleh: e.target.value })
              }
            />
          </div>
        </div>
          ...
          <div className="flex flex-col gap-2 bg-slate-50 p-3 border border-slate-200 rounded-sm">
            ...
            <label className="flex items-center gap-2 text-sm font-semibold text-slate-700 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, is_closed: e.target.checked })
                }
          ...
          <div className="border border-slate-300 p-3 relative mt-2 rounded-sm bg-white shadow-sm">
            ...
            <div className="flex gap-2 mt-2">
              ...
              <input
                ...
                readOnly
                value={form.create_uid_name || "Unknown"}
              />
            </div>
          </div>
          <div className="border border-slate-300 p-3 relative mt-1 rounded-sm bg-white shadow-sm">
            ...
            <div className="flex gap-2 mt-2">
              ...
              <input
                ...
                className="w-20 px-2 py-1.5 text-xs border border-slate-200 bg-slate-50 text-center rounded-sm"
                readOnly
                value={form.write_uid_name || "Unknown"}
              />
            </div>
          </div>
        </div>
