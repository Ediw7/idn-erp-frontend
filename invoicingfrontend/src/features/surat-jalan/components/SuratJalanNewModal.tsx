        ...
        <div className="bg-slate-800 px-6 py-4 flex justify-between items-center text-white shrink-0">
          <div>
            ...
            <p className="text-xs text-slate-300 mt-0.5">
              Isi detail dokumen header sebelum menambahkan pengiriman barang.
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    value={modalForm.no_sj || ""}
                    onChange={(e) =>
                      setModalForm({ ...modalForm, no_sj: e.target.value })
                    }
                  />
                  <button
                    ...
                    onClick={async () => {
                      const defGudangId =
                        gudangs.find((g) => g.is_default)?.id || "";
                      const autoNo = await getSjAutoNo();
                      setModalForm({
                        ...modalForm,
                        gudang_id: String(defGudangId),
                        no_sj: autoNo,
                      });
                    }}
                  >
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setModalForm({ ...modalForm, tanggal: e.target.value })
                  }
                />
              </div>
              <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                ...
                <select
                  className={inputClass}
                  value={modalForm.gudang_id || ""}
                  onChange={(e) =>
                    setModalForm({ ...modalForm, gudang_id: e.target.value })
                  }
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleSOChange(modalForm, setModalForm, e.target.value)
                    }
                  >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    type="text"
                    className={inputClass}
                    value={modalForm.no_po || ""}
                    onChange={(e) =>
                      setModalForm({ ...modalForm, no_po: e.target.value })
                    }
                  />
                </div>
              </div>
              <div className="flex flex-col gap-1">
                ...
                <input
                  type="text"
                  className={inputClass}
                  value={modalForm.no_kendaraan || ""}
                  onChange={(e) =>
                    setModalForm({ ...modalForm, no_kendaraan: e.target.value })
                  }
                />
              </div>
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setModalForm({ ...modalForm, keterangan: e.target.value })
                  }
                />
              </div>
            </div>
