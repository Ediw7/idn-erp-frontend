...
export const KwitansiFormView: React.FC<KwitansiFormViewProps> = ({
  ...
  const btnClass = "px-4 py-1.5 text-sm font-semibold rounded-sm transition-colors flex items-center justify-center gap-2";
        ...
        <div className="flex gap-12 max-w-5xl">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex items-center">
              ...
              <select className={`${inputClass} w-32`} value={form.jenis || 'VAT'} onChange={e => setForm({...form, jenis: e.target.value})}>
            ...
            <div className="flex items-center">
              ...
              <input type="date" className={`${inputClass} w-40`} value={form.tgl_kwitansi || ''} onChange={e => setForm({...form, tgl_kwitansi: e.target.value})} />
            </div>
            ...
            <div className="flex items-center mt-2">
              ...
              <div className="flex gap-2 flex-1">
                <select className={inputClass} value={form.pembeli_id || ''} onChange={e => handlePembeliChange(e.target.value ? Number(e.target.value) : '')}>
                  <option value="">{loadingData ? 'Loading...' : '-- Pilih Pelanggan --'}</option>
