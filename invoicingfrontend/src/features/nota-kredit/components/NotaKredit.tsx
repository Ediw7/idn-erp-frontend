...
import { Search, Save, FileText, X, FileMinus } from 'lucide-react';
      ...
      <div className="bg-slate-800 px-4 py-2 flex justify-between items-center shrink-0 overflow-x-auto">
        <div className="flex items-center gap-3 shrink-0">
          <div className="text-white font-bold text-lg flex items-center gap-2">
            <FileMinus size={20} className="text-blue-400" />
            <span className="tracking-wide uppercase">Transaksi Nota Kredit</span>
          </div>
