...
const SetupDataBaru: React.FC = () => {
  ...
  const inputClass =
    "w-full px-3 py-2 bg-white border border-slate-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-sm text-sm transition-shadow";
      ...
      <div className="bg-slate-800 px-6 py-5 flex justify-between items-start shrink-0">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Konfigurasi awal profil perusahaan dan alokasi database sistem.
          </p>
        </div>
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6 rounded-r-md shadow-sm flex items-start gap-3">
            ...
            <p className="text-sm text-amber-800 leading-relaxed font-medium">
              Proses Setup Data Baru hanya diperlukan dengan syarat Anda ingin
              menginput data bukan dimulai dari tahun 2020 dan proses ini hanya
              boleh dijalankan sekali saja.
            </p>
          </div>
