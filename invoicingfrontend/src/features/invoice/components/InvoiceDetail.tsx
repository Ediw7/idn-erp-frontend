...
export const InvoiceDetail: React.FC<InvoiceDetailProps> = ({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-sm shadow-sm flex flex-col mt-6">
      <h3 className="text-sm font-bold text-slate-800 mb-0 pt-6 px-6 pb-2 border-b border-slate-200">
        Detail Barang/Jasa
      </h3>
              ...
              form.lines.map((line: any, idx: number) => {
                ...
                return (
                  <tr key={idx} className="hover:bg-slate-50 transition-colors">
                    <td className="px-3 py-2 text-center border-r border-slate-200 font-bold text-slate-500">
                      {idx + 1}
                    </td>
                    <td className="px-3 py-2 border-r border-slate-200">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-slate-600 truncate max-w-[200px]">
                          {itemInfo?.nama || "Item tidak ditemukan"}
                        </span>
                        {line.keterangan && (
