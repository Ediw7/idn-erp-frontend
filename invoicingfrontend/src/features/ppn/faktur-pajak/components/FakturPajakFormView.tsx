...
export const FakturPajakFormView: React.FC<FakturPajakFormViewProps> = ({
  ...
  (form.lines || []).forEach((line: any) => {
    totalHargaJual +=
      (line.kuantum || 0) * (line.harga_satuan || 0) - (line.disc_footer || 0);
  });
                          ...
                          const applyInvoice = (invoice: any) => {
                            if (invoice) {
                              setForm({
                                ...
                                no_invoice: val,
                                pembeli_id:
                                  invoice.pembeli_id || form.pembeli_id,
                                lines:
                  ...
                  <div className="grid grid-cols-3 gap-2 items-start">
                    ...
                    <div className="col-span-2 flex flex-col gap-2">
                      <select
                        ...
                        onChange={(e) => {
                          const selected = tandaTangans.find(
                      ...
                      {tandaTangans?.find((t) => t.nama === form.penandatangan)
                        ?.ttd_image && (
                ...
                <table className="w-full text-xs text-left">
                  <thead className="bg-slate-100 border-b border-slate-200">
                    <tr>
                      ...
                      <th className="px-3 py-2 font-bold text-slate-700 min-w-[200px]">
                        Barang
                      </th>
                      <th className="px-3 py-2 font-bold text-slate-700 w-16">
                        Satuan
                      </th>
                      ...
                      <tr key={idx} className="group hover:bg-slate-50/50">
                        ...
                        <td className="px-3 py-2">
                          <input
                            ...
                            className={
                              inputClass +
                              " text-right bg-slate-50 font-semibold"
                            }
          ...
          <div className="w-full max-w-sm space-y-3 pt-2">
            <div className="flex justify-between items-center text-sm font-semibold text-slate-800">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-right w-32 px-2 py-1">
                  {Number(totalHargaJual || 0).toLocaleString("en-US", {
            ...
            <div className="flex justify-between items-center text-sm">
              <label className="flex items-center gap-2 cursor-pointer text-slate-600 font-semibold">
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, is_dpp_valas: e.target.checked })
                  }
            ...
            <div className="flex justify-between items-center text-base">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-lg font-bold text-slate-800 text-right w-32">
                  {Number(dppSetelahPotongan || 0).toLocaleString("en-US", {
                    minimumFractionDigits: 2,
                  })}
                </span>
              </div>
            ...
            <div className="flex justify-between items-center text-base">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-lg font-bold text-slate-800 text-right w-32">
                  {Number(ppn || 0).toLocaleString("en-US", {
                    minimumFractionDigits: 2,
                  })}
                </span>
              </div>
