...
export const SuratSetoranPajakFormView: React.FC<FormViewProps> = ({
  ...
  const numInputClass =
    "w-full px-3 py-1.5 bg-white border border-slate-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-sm text-sm text-right font-mono font-bold text-blue-700 disabled:bg-slate-50 disabled:text-slate-500 transition-colors";
          ...
          <div className="flex gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  type="text"
                  className={`${inputClass} w-24 font-mono font-bold py-1`}
                  value={form.tahun}
          ...
          <div className="overflow-x-auto min-h-[400px]">
            <div className="p-6 shrink-0 max-w-4xl flex flex-col gap-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <textarea
                  className={`${inputClass} w-full resize-none h-16`}
                  value={form.alamat}
              ...
              <div className="flex items-start gap-4 mt-2 border-t border-slate-200 pt-4">
                ...
                <div className="flex items-center gap-2 w-full">
                  <select
                    ...
                    value={form.kode_jenis_pajak}
                    onChange={(e) =>
                      setForm({ ...form, kode_jenis_pajak: e.target.value })
                    }
                  >
                  ...
                  <input
                    ...
                    readOnly
                    value={form.kode_jenis_pajak_desc}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        kode_jenis_pajak_desc: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex items-center gap-2 w-full">
                  <select
                    className={`${inputClass} w-40`}
                    value={form.kode_jenis_setoran}
                    onChange={(e) =>
                      setForm({ ...form, kode_jenis_setoran: e.target.value })
                    }
                  >
                  ...
                  <input
                    ...
                    className={`${inputClass} flex-1 bg-slate-50`}
                    readOnly
                    value={form.kode_jenis_setoran_desc}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        kode_jenis_setoran_desc: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <textarea
                  className={`${inputClass} w-full resize-none h-16`}
                  value={form.uraian_pembayaran}
                  onChange={(e) =>
                    setForm({ ...form, uraian_pembayaran: e.target.value })
                  }
                />
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <input
                  type="text"
                  className={`${inputClass} w-64`}
                  value={form.no_ketetapan}
                  onChange={(e) =>
                    setForm({ ...form, no_ketetapan: e.target.value })
                  }
                />
                <span className="text-xs font-semibold text-slate-700 shrink-0 mt-1 ml-4">
                  NTPP
                </span>
                <input
                  type="text"
                  className={`${inputClass} w-64`}
                  value={form.ntpp}
                  onChange={(e) => setForm({ ...form, ntpp: e.target.value })}
                />
              </div>
              ...
              <div className="flex items-center gap-4 mt-2">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    checked={form.ssp_pemungut}
                    onChange={(e) =>
                      setForm({ ...form, ssp_pemungut: e.target.checked })
                    }
                  />
                </label>
              </div>
