                          ...
                          if (fp) {
                            ...
                            const applyFakturPajak = () => {
                              setForm({
                                ...
                                pelanggan_id:
                                  fp.pembeli_id || form.pelanggan_id,
                                alamat_pembeli:
                                  fp.alamat || form.alamat_pembeli,
                                mata_uang_id:
                  ...
                  <div className="flex items-start mt-2">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        const fp = fakturPajaks?.find(
                          (f) => f.no_invoice === invNo,
                        );
                        const inv = invoices?.find(
                          (i: any) => (i.no_invoice || i.id) === invNo,
                        );
                      ...
                      >
                        ...
                        <td className="px-2 py-1.5 border-r border-slate-200 text-right">
                          <input
                            ...
                            value={line.kuantum || ""}
                            onChange={(e) =>
                              updateLine(idx, "kuantum", Number(e.target.value))
                            }
                          />
                        </td>
                        <td className="px-2 py-1.5 border-r border-slate-200 text-right">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className={`${inputClass} bg-slate-100`}
                    value={
                      pelanggans.find((p) => p.id === form.pelanggan_id)
                        ?.nama || ""
                    }
                    readOnly
                  />
