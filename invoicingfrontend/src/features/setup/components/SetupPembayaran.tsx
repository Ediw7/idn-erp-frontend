...
const SetupPembayaran: React.FC = () => {
  const {
    ...
    validate: (form) =>
      !form.kode || !form.nama ? "Kode dan Cara Pembayaran harus diisi!" : null,
  });
      ...
      <div className="bg-slate-800 px-6 py-4 border-b border-slate-700 flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold text-white">
            Setup Cara Pembayaran (Terms of Payment)
          </h2>
          <p className="text-xs text-slate-300 mt-1">
            Konfigurasi opsi pembayaran dan perhitungan jatuh tempo.
          </p>
        </div>
        <button
              ...
              <tbody className="text-sm text-slate-700 divide-y divide-slate-100">
                ...
                {list.length === 0 && (
                  <tr>
                    ...
                    >
                      Belum ada data cara pembayaran. Klik "Tambah Baru" untuk
                      memulai.
                    </td>
                  </tr>
                )}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({
                        ...editForm,
                        hari_jatuh_tempo: Number(e.target.value),
                      })
                    }
                    className={inputClass}
                  />
