  ...
  return (
    <div className="bg-white shadow-sm border border-slate-300 max-w-5xl mx-auto mt-8">
      ...
      <div className="bg-slate-800 px-6 py-4 border-b border-slate-700 flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold text-white">Setup Salesman</h2>
          <p className="text-xs text-slate-300 mt-1">Daftar nama penjual atau marketing.</p>
        </div>
        <button 
                ...
                {list.length === 0 && (
                  <tr>
                    <td colSpan={4} className="px-4 py-8 text-center text-slate-500 text-sm">
                      Belum ada data salesman. Klik "Tambah Baru" untuk memulai.
                    </td>
                  </tr>
                )}
              </tbody>
          ...
          <div className="bg-white rounded shadow-xl max-w-md w-full flex flex-col">
            <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center bg-slate-50">
              <h3 className="font-bold text-slate-800">
                {editForm.id ? 'UBAH Salesman' : 'Tambah Salesman'}
              </h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    placeholder="Contoh: AN"
                    autoFocus
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 mb-1">Nama Salesman</label>
                  <input 
                    type="text" 
                    value={editForm.nama} 
