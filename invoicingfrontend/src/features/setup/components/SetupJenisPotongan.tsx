...
const SetupJenisPotongan: React.FC = () => {
  ...
  const {
    ...
    validate: (form) =>
      !form.kode || !form.nama ? "Kode dan Jenis Potongan harus diisi!" : null,
  });
      ...
      <div className="bg-slate-800 px-6 py-4 border-b border-slate-700 flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold text-white">
            Setup Jenis Potongan
          </h2>
          <p className="text-xs text-slate-300 mt-1">
            Daftar jenis potongan biaya yang dikenakan pada invoice.
          </p>
        </div>
        <button
              ...
              <tbody className="text-sm text-slate-700 divide-y divide-slate-100">
                ...
                {list.length === 0 && (
                  <tr>
                    ...
                    >
                      Belum ada data jenis potongan. Klik "Tambah Baru" untuk
                      memulai.
                    </td>
                  </tr>
                )}
