      ...
      <div className="bg-slate-800 px-6 py-4 border-b border-slate-700 flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-slate-300 mt-1">
            Konfigurasi identitas utama dan legalitas perpajakan perusahaan
            (NPWP).
          </p>
        </div>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="PT. EDI Accounting System"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Jl. Jend. Sudirman Kav. 88"
                  />
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={inputClass}
                    placeholder="www.ediaccounting.com"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={inputClass}
                    placeholder="admin@ediaccounting.com"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <select
                      name="tahun_buku_start"
                      value={formData.tahun_buku_start}
                      onChange={handleChange}
                      className={inputClass}
                    >
                      {[...Array(12)].map((_, i) => (
