...
const SetupPelanggan: React.FC = () => {
  ...
  const {
    ...
    validate: (form) =>
      !form.kode || !form.nama ? "Kode dan Nama Pelanggan harus diisi!" : null,
  });
  ...
  const handleExportExcel = () => {
    const exportData = list.map((item) => ({
      ...
      "No Perkiraan Piutang":
        perkiraans.find((p) => p.id === item.perk_piutang_id)?.no_perkiraan ||
        "",
      ...
      try {
        ...
        const importPromise = Promise.all(
          itemsToImport.map((item) =>
            setupApi.savePelanggan(item as PelangganData),
          ),
        );
  ...
  const inputClass =
    "w-full px-2 py-1 bg-white border border-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-500/20 focus:border-slate-500 text-xs transition-colors rounded-sm";
      ...
      <div className="bg-slate-800 px-6 py-4 flex justify-between items-center shrink-0">
        <div>
          <h2 className="text-lg font-semibold text-white">
            Setup Pelanggan (Customer)
          </h2>
          <p className="text-xs text-slate-300 mt-1">
            Daftar pelanggan, NPWP, dan aturan harga/diskon.
          </p>
        </div>
              ...
              <tbody className="text-sm text-slate-700 divide-y divide-slate-100">
                ...
                {list.length === 0 && (
                  <tr>
                    ...
                    >
                      Belum ada data pelanggan. Klik "Tambah Baru" atau "Import
                      Dari Excel".
                    </td>
                  </tr>
                )}
              ...
              <div className="flex gap-8">
                ...
                <div className="flex-1 flex flex-col gap-3">
                  <div className="flex items-center gap-4">
                    ...
                    <label
                      ...
                      title="Centang jika pelanggan ini adalah pelanggan luar negeri (Ekspor)"
                    >
                      <input
                        type="checkbox"
                        ...
                        onChange={(e) => {
                          ...
                          setEditForm({
                            ...
                            npwp: checked
                              ...
                              : editForm.npwp === "00.000.000.0-000.000"
                                ? ""
                                : editForm.npwp,
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="flex-1 flex items-center">
                      <label className="w-20 text-xs font-semibold text-slate-700 shrink-0 text-right pr-3">
                        No. Fax
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 flex items-center">
                      ...
                      <input
                        type="text"
                        value={editForm.telepon_kirim || ""}
                        onChange={(e) =>
                          setEditForm({
                            ...editForm,
                            telepon_kirim: e.target.value,
                          })
                        }
                        className={inputClass}
                      />
                    ...
                    <div className="flex-1 flex items-center">
                      ...
                      <input
                        type="text"
                        value={editForm.fax_kirim || ""}
                        onChange={(e) =>
                          setEditForm({
                            ...editForm,
                            fax_kirim: e.target.value,
                          })
                        }
                        className={inputClass}
                      />
                ...
                <div className="flex-1 flex flex-col gap-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      type="text"
                      value={editForm.ket_tambahan || ""}
                      onChange={(e) =>
                        setEditForm({
                          ...editForm,
                          ket_tambahan: e.target.value,
                        })
                      }
                      className={inputClass}
                    />
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="flex-1 flex items-center">
                      <label className="w-16 text-xs font-semibold text-slate-700 shrink-0 text-right pr-3">
                        No HP
                      </label>
                      <input
                        type="text"
              ...
              <div className="mt-2 pt-6 border-t border-slate-200 grid grid-cols-2 gap-8">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <select
                      value={editForm.tingkat_harga || "1"}
                      onChange={(e) =>
                        setEditForm({
                          ...editForm,
                          tingkat_harga: e.target.value,
                        })
                      }
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center">
                    ...
                    <select
                      value={editForm.perk_piutang_id || ""}
                      onChange={(e) =>
                        setEditForm({
                          ...editForm,
                          perk_piutang_id: e.target.value
                            ? Number(e.target.value)
                            : null,
                        })
                      }
