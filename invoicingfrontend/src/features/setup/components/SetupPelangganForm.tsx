...
const SetupPelangganForm: React.FC<SetupPelangganFormProps> = ({
  onClose,
  onSuccess,
}) => {
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex items-start mt-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setEditForm({ ...editForm, alamat_kirim: e.target.value })
                }
                className={`${inputClass} h-16 resize-none`}
              />
            </div>
            <div className="flex gap-2">
              <div className="flex-1 flex items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, telepon_kirim: e.target.value })
                  }
                  className={inputClass}
                />
              </div>
              <div className="flex-1 flex items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, fax_kirim: e.target.value })
                  }
                  className={inputClass}
                />
              </div>
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex items-center mt-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setEditForm({ ...editForm, jenis_transaksi: e.target.value })
                }
                className={inputClass}
              >
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center">
              ...
              <select
                ...
                onChange={(e) =>
                  setEditForm({ ...editForm, tingkat_harga: e.target.value })
                }
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center w-32">
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, diskon: Number(e.target.value) })
                  }
