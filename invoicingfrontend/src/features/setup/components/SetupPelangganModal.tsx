...
export const SetupPelangganModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onSaved,
}) => {
  ...
  const btnClass =
    "px-4 py-1.5 text-sm font-semibold rounded-md transition-colors flex items-center justify-center gap-2 shadow-sm";
  const inputClass =
    "w-full px-2 py-1.5 text-sm border border-slate-300 rounded-sm focus:outline-none focus:border-blue-500 bg-white h-8";
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                ...
                <div className="flex gap-2 w-full items-center">
                  <input
                    type="text"
                    className={`${inputClass} font-mono w-40 uppercase`}
                    value={form.kode || ""}
                    onChange={(e) => setForm({ ...form, kode: e.target.value })}
                  />
                  <button className="px-3 h-8 border border-slate-300 bg-slate-100 hover:bg-slate-200 rounded-sm flex items-center justify-center">
                    <Search size={14} />
                  </button>
                  <label className="ml-4 flex items-center gap-2 text-sm font-semibold text-slate-700 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={form.is_ekspor || false}
                      onChange={(e) =>
                        setForm({ ...form, is_ekspor: e.target.checked })
                      }
              ...
              <div>
                ...
                <textarea
                  className="w-full px-2 py-1.5 text-sm border border-slate-300 rounded-sm focus:outline-none focus:border-blue-500 bg-white h-16 resize-none"
                  value={form.alamat || ""}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.no_fax || ""}
                    onChange={(e) =>
                      setForm({ ...form, no_fax: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setForm({ ...form, alamat_kirim: e.target.value })
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    className={inputClass}
                    value={form.no_telp_kirim || ""}
                    onChange={(e) =>
                      setForm({ ...form, no_telp_kirim: e.target.value })
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    type="text"
                    className={inputClass}
                    value={form.no_fax_kirim || ""}
                    onChange={(e) =>
                      setForm({ ...form, no_fax_kirim: e.target.value })
                    }
                  />
                </div>
              </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.nama_wp || ""}
                    onChange={(e) =>
                      setForm({ ...form, nama_wp: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={form.no_ktp || ""}
                      onChange={(e) =>
                        setForm({ ...form, no_ktp: e.target.value })
                      }
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-2 py-1.5 text-sm border border-slate-300 rounded-sm focus:outline-none focus:border-blue-500 bg-white h-16 resize-none"
                    value={form.alamat_wp || ""}
                    onChange={(e) =>
                      setForm({ ...form, alamat_wp: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="3">
                        3 - Pemungut Selain Bendaharawan
                      </option>
                    </select>
                  </div>
                  <div>
                    ...
                    <select
                      className={`${inputClass} bg-slate-200 text-slate-500 cursor-not-allowed`}
                      disabled
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setForm({ ...form, cara_pembayaran: e.target.value })
                      }
                    >
                  ...
                  <div>
                    ...
                    <select
                      className={inputClass}
                      value={form.tingkatan_harga_jual || ""}
                      onChange={(e) =>
                        setForm({
                          ...form,
                          tingkatan_harga_jual: e.target.value,
                        })
                      }
                    >
                      <option value="">-- Pilih --</option>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        type="number"
                        className={`${inputClass} text-right w-full`}
                        value={form.discount_harga_jual || 0}
                        onChange={(e) =>
                          setForm({
                            ...form,
                            discount_harga_jual: Number(e.target.value),
                          })
                        }
                      />
                      <span className="flex items-center justify-center bg-slate-100 border border-slate-300 rounded-sm px-3 font-bold text-slate-600">
                        %
                      </span>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <select
                    className={inputClass}
                    value={form.no_perkiraan_piutang || ""}
                    onChange={(e) =>
                      setForm({ ...form, no_perkiraan_piutang: e.target.value })
                    }
                  >
        ...
        <div className="bg-slate-100 px-6 py-4 border-t border-slate-300 flex justify-between items-center shrink-0 rounded-b-md">
          <div className="flex gap-4">
            <div className="flex flex-col">
              ...
              <span className="text-xs font-mono text-slate-700 bg-white px-2 py-0.5 border border-slate-200 rounded-sm mt-0.5 shadow-sm">
                - / {user?.name || "Admin"}
              </span>
            </div>
            <div className="flex flex-col">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className={`${btnClass} bg-white text-slate-700 border border-slate-300 hover:bg-slate-50`}
            >
              BATAL
            </button>
            <button
              onClick={handleSave}
              disabled={loading}
              className={`${btnClass} bg-blue-600 text-white border border-transparent hover:bg-blue-700 w-48 disabled:opacity-50`}
            >
              {loading ? (
                "MENYIMPAN..."
              ) : (
                <>
                  <Save size={16} /> SIMPAN PELANGGAN
                </>
              )}
            </button>
          </div>
