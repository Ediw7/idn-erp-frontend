        ...
        <div className="bg-white border border-slate-200 rounded-sm shadow-sm overflow-x-auto flex-1">
          <table className="w-full text-xs text-left whitespace-nowrap">
            <thead className="bg-slate-100 border-b border-slate-200">
              <tr>
                <th className="px-3 py-2 font-semibold text-slate-700 text-center w-12">
                  No.
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700">
                  No. Bukti
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700 text-center w-28">
                  Tgl
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700">
                  Nama Pembeli
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700 text-center w-16">
                  Curr
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700 text-right w-32">
                  Jumlah
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700 w-28">
                  Metode Bayar
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700 w-32">
                  No. Giro
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700">
                  Keterangan
                </th>
                <th className="px-3 py-2 font-semibold text-slate-700 text-center w-20">
                  Aksi
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {filteredData.length === 0 ? (
                <tr>
                  ...
                  >
                    Belum ada data pembayaran piutang. Klik "+ BUKA FORM" untuk
                    memulai.
                  </td>
                </tr>
              ) : (
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-3 py-2 font-mono text-slate-800 text-right font-semibold">
                        {(item.jumlah_penerimaan || 0).toLocaleString("en-US", {
