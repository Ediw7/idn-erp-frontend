    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/40 p-4 backdrop-blur-sm">
      <div className="bg-white w-full max-w-2xl rounded-md shadow-2xl flex flex-col overflow-hidden border border-slate-300">
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] flex flex-col gap-6 bg-slate-50">
          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col gap-1.5">
              ...
              >
                ...
                {editLineIndex !== null && (
                  <option value={lineForm.no_invoice}>
                    {lineForm.no_invoice}
                  </option>
                )}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                readOnly
                value={lineForm.no_faktur_pajak || "-"}
              />
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-semibold text-slate-700">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                type="text"
                className={`${readOnlyClass} font-mono text-right`}
                readOnly
                value={saldoPiutang.toLocaleString("en-US", {
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                onChange={(e) =>
                  setLineForm({
                    ...lineForm,
                    pembayaran: parseFloat(e.target.value) || 0,
                  })
                }
                min="0"
              />
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                readOnly
                value={saldoAkhir.toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                })}
              />
            </div>
        ...
        <div className="bg-white px-6 py-4 border-t border-slate-200 flex justify-end gap-3 shrink-0">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-semibold text-slate-700 bg-white border border-slate-300 hover:bg-slate-50 rounded-sm transition-colors shadow-sm"
          >
            Batal
          </button>
          <button
            onClick={handleSave}
            className="px-4 py-2 text-sm font-semibold text-white bg-blue-600 border border-transparent rounded-sm hover:bg-blue-700 transition-colors shadow-sm flex items-center gap-2"
          >
            <Save size={16} />{" "}
            {editLineIndex !== null
              ? "Simpan Perubahan"
