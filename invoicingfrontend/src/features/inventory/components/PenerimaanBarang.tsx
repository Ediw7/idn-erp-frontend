...
const PenerimaanBarang: React.FC = () => {
  ...
  const readOnlyClass =
    "w-full px-3 py-2 border border-slate-200 bg-gray-50 text-gray-500 rounded-sm text-sm font-semibold focus:outline-none";
      ...
      <div className="p-6 bg-slate-900 w-full rounded-none flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-300 mt-1">
            Form input penerimaan barang dari supplier ke gudang
          </p>
        </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  value={form.no_bukti}
                  onChange={(e) =>
                    setForm({ ...form, no_bukti: e.target.value })
                  }
                />
                <button
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, no_faktur: e.target.value })
                }
              />
            </div>
          </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-gray-50 text-slate-700 text-xs uppercase border-b border-slate-200">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold w-[10%] text-right">
                  Qty
                </th>
                ...
                >
                  ...
                  <td className="p-2">
                    <input
                      type="text"
                      readOnly
                      className="w-full px-2 py-1.5 bg-gray-50 border border-slate-200 text-slate-500 rounded text-sm"
