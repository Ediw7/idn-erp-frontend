      ...
      <ConfirmProvider>
        <AuthProvider>
          <Toaster
            ...
            toastOptions={{
              className:
                "text-sm font-semibold rounded-sm shadow-md border border-slate-200",
              success: {
                style: {
                  background: "#f0fdf4",
                  color: "#166534",
            ...
            <Routes>
              ...
              >
                ...
                <Route
                  ...
                  element={<OutstandingInvoice />}
                />
                <Route
                  path="rangkuman-penjualan"
                  element={<RangkumanPenjualan />}
                />
                ...
                <Route
                  path="inventory/saldo-awal"
                  element={<SaldoAwalInventory />}
                />
                <Route
                  path="inventory/penerimaan"
                ...
                <Route
                  path="ppn/transfer-efaktur"
                  element={<TransferEFaktur />}
                />
                <Route
                  path="pemeliharaan/ganti-password"
