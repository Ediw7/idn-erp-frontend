          ...
          <ul className="space-y-1">
            ...
            <li>
              ...
              >
                ...
                <svg
                  className={`w-3 h-3 transition-transform duration-200 ${isSetupOpen ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${isSetupOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}
              >
            ...
            <li>
              ...
              >
                <span>PPN</span>
                <svg
                  className={`w-4 h-4 transition-transform duration-200 ${isPpnOpen ? "transform rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${isPpnOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}
              >
            ...
            <li>
              ...
              >
                <span>Inventory</span>
                <svg
                  className={`w-4 h-4 transition-transform duration-200 ${isInventoryOpen ? "transform rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${isInventoryOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}
              >
                <ul className="bg-slate-950 py-2">
            ...
            <li>
              ...
              >
                ...
                <svg
                  className={`w-4 h-4 transition-transform duration-200 ${isPemeliharaanOpen ? "transform rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${isPemeliharaanOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}
              >
                <ul className="bg-slate-950 py-2">
            ...
            <li>
              ...
              >
                <span
                  className={
                    location.pathname === "/setup-data-baru"
                      ? "text-white"
                      : "text-yellow-400"
                  }
                >
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm font-bold text-slate-800 tracking-wide uppercase">
                {user?.company_name || "PT. EDI Accounting System"}
              </p>
